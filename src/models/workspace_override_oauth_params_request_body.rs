...
impl WorkspaceOverrideOauthParamsRequestBody {
    pub fn new(definition_id: uuid::Uuid, params: ::std::collections::HashMap<String, serde_json::Value>, workspace_id: uuid::Uuid, actor_type: crate::models::ActorType) -> WorkspaceOverrideOauthParamsRequestBody {
