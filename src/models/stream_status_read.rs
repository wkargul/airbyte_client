...
impl StreamStatusRead {
    pub fn new(attempt_number: i32, connection_id: uuid::Uuid, id: uuid::Uuid, job_id: i64, job_type: crate::models::StreamStatusJobType, run_state: crate::models::StreamStatusRunState, stream_name: String, stream_namespace: String, transitioned_at: i64, workspace_id: uuid::Uuid) -> StreamStatusRead {
        StreamStatusRead {
            attempt_number,
            connection_id,
            id,
