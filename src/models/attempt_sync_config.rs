...
pub struct AttemptSyncConfig {
    ...
    #[serde(rename = "sourceConfiguration", deserialize_with = "Option::deserialize")]
    pub source_configuration: Option<serde_json::Value>,
    /// The values required to configure the destination. The schema for this must match the schema return by destination_definition_specifications/get for the destinationDefinition.
    #[serde(rename = "destinationConfiguration", deserialize_with = "Option::deserialize")]
...
impl AttemptSyncConfig {
    pub fn new(source_configuration: Option<serde_json::Value>, destination_configuration: Option<serde_json::Value>) -> AttemptSyncConfig {
        AttemptSyncConfig {
