...
impl DeclarativeSourceDefinitionCreateManifestRequestBody {
    pub fn new(workspace_id: uuid::Uuid, source_definition_id: uuid::Uuid, set_as_active_manifest: bool, declarative_manifest: crate::models::DeclarativeSourceManifest) -> DeclarativeSourceDefinitionCreateManifestRequestBody {
