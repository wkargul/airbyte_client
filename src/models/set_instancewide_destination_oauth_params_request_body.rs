...
impl SetInstancewideDestinationOauthParamsRequestBody {
    pub fn new(destination_definition_id: uuid::Uuid, params: ::std::collections::HashMap<String, serde_json::Value>) -> SetInstancewideDestinationOauthParamsRequestBody {
