...
pub struct DestinationRead {
    ...
    #[serde(rename = "connectionConfiguration", deserialize_with = "Option::deserialize")]
...
impl DestinationRead {
    pub fn new(destination_definition_id: uuid::Uuid, destination_id: uuid::Uuid, workspace_id: uuid::Uuid, connection_configuration: Option<serde_json::Value>, name: String, destination_name: String) -> DestinationRead {
        DestinationRead {
