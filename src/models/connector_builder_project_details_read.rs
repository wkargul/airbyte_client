...
pub struct ConnectorBuilderProjectDetailsRead {
    ...
    #[serde(rename = "activeDeclarativeManifestVersion", skip_serializing_if = "Option::is_none")]
...
impl ConnectorBuilderProjectDetailsRead {
    pub fn new(name: String, builder_project_id: uuid::Uuid, has_draft: bool) -> ConnectorBuilderProjectDetailsRead {
