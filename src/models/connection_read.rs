...
pub struct ConnectionRead {
    ...
    #[serde(rename = "notifySchemaChanges", skip_serializing_if = "Option::is_none")]
    pub notify_schema_changes: Option<bool>,
    #[serde(rename = "notifySchemaChangesByEmail", skip_serializing_if = "Option::is_none")]
    pub notify_schema_changes_by_email: Option<bool>,
    #[serde(rename = "nonBreakingChangesPreference", skip_serializing_if = "Option::is_none")]
...
impl ConnectionRead {
    pub fn new(connection_id: uuid::Uuid, name: String, source_id: uuid::Uuid, destination_id: uuid::Uuid, sync_catalog: crate::models::AirbyteCatalog, status: crate::models::ConnectionStatus, breaking_change: bool) -> ConnectionRead {
        ConnectionRead {
            connection_id,
            name,
