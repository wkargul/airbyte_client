...
pub struct SynchronousJobRead {
    ...
    pub succeeded: bool,
    #[serde(rename = "connectorConfigurationUpdated", skip_serializing_if = "Option::is_none")]
...
impl SynchronousJobRead {
    pub fn new(id: uuid::Uuid, config_type: crate::models::JobConfigType, created_at: i64, ended_at: i64, succeeded: bool) -> SynchronousJobRead {
        SynchronousJobRead {
            id,
            config_type,
            config_id: None,
