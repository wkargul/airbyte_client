...
impl JobDebugRead {
    pub fn new(id: i64, config_type: crate::models::JobConfigType, config_id: String, status: crate::models::JobStatus, airbyte_version: String, source_definition: crate::models::SourceDefinitionRead, destination_definition: crate::models::DestinationDefinitionRead) -> JobDebugRead {
        JobDebugRead {
            id,
            config_type,
            config_id,
