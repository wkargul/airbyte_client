...
impl StreamStatusUpdateRequestBody {
    pub fn new(id: uuid::Uuid, attempt_number: i32, connection_id: uuid::Uuid, job_id: i64, job_type: crate::models::StreamStatusJobType, run_state: crate::models::StreamStatusRunState, stream_name: String, transitioned_at: i64, workspace_id: uuid::Uuid) -> StreamStatusUpdateRequestBody {
