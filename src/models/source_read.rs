...
impl SourceRead {
    pub fn new(source_definition_id: uuid::Uuid, source_id: uuid::Uuid, workspace_id: uuid::Uuid, connection_configuration: Option<serde_json::Value>, name: String, source_name: String) -> SourceRead {
        SourceRead {
