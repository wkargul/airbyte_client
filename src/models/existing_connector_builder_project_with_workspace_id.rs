...
impl ExistingConnectorBuilderProjectWithWorkspaceId {
    pub fn new(workspace_id: uuid::Uuid, builder_project_id: uuid::Uuid, builder_project: crate::models::ConnectorBuilderProjectDetails) -> ExistingConnectorBuilderProjectWithWorkspaceId {
