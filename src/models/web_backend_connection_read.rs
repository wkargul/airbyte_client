...
impl WebBackendConnectionRead {
    pub fn new(connection_id: uuid::Uuid, name: String, source_id: uuid::Uuid, destination_id: uuid::Uuid, sync_catalog: crate::models::AirbyteCatalog, status: crate::models::ConnectionStatus, source: crate::models::SourceRead, destination: crate::models::DestinationRead, is_syncing: bool, schema_change: crate::models::SchemaChange, notify_schema_changes: bool, notify_schema_changes_by_email: bool, non_breaking_changes_preference: crate::models::NonBreakingChangesPreference) -> WebBackendConnectionRead {
