...
pub struct SourceDefinitionRead {
    ...
    #[serde(rename = "maxSecondsBetweenMessages", skip_serializing_if = "Option::is_none")]
    pub max_seconds_between_messages: Option<i64>,
}

impl SourceDefinitionRead {
    pub fn new(source_definition_id: uuid::Uuid, name: String, docker_repository: String, docker_image_tag: String) -> SourceDefinitionRead {
