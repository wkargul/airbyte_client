...
impl ConnectorBuilderPublishRequestBody {
    pub fn new(workspace_id: uuid::Uuid, builder_project_id: uuid::Uuid, name: String, initial_declarative_manifest: crate::models::DeclarativeSourceManifest) -> ConnectorBuilderPublishRequestBody {
