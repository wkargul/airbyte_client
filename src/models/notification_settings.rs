...
pub struct NotificationSettings {
    ...
    #[serde(rename = "sendOnSyncDisabledWarning", skip_serializing_if = "Option::is_none")]
    pub send_on_sync_disabled_warning: Option<Box<crate::models::NotificationItem>>,
    #[serde(rename = "sendOnConnectionUpdate", skip_serializing_if = "Option::is_none")]
    pub send_on_connection_update: Option<Box<crate::models::NotificationItem>>,
    #[serde(rename = "sendOnConnectionUpdateActionRequired", skip_serializing_if = "Option::is_none")]
