...
pub struct CompleteSourceOauthRequest {
    ...
    #[serde(rename = "oAuthInputConfiguration", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "returnSecretCoordinate", skip_serializing_if = "Option::is_none")]
...
impl CompleteSourceOauthRequest {
    pub fn new(source_definition_id: uuid::Uuid, workspace_id: uuid::Uuid) -> CompleteSourceOauthRequest {
