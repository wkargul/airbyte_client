...
pub struct ConnectorBuilderProjectRead {
    ...
    #[serde(rename = "declarativeManifest", skip_serializing_if = "Option::is_none")]
    pub declarative_manifest: Option<Box<crate::models::DeclarativeManifestRead>>,
}

impl ConnectorBuilderProjectRead {
    pub fn new(builder_project: crate::models::ConnectorBuilderProjectDetailsRead) -> ConnectorBuilderProjectRead {
